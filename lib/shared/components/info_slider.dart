  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: OnBoardingSlider(
        ...
        speed: 1,
        pageBodies: [
          Text('فوائد التبرع بالدم',style: TextStyle(fontSize: 18),),
          Text('فوائد التبرع بالدم',style: TextStyle(fontSize: 18)),
          Text('فوائد التبرع بالدم',style: TextStyle(fontSize: 18)),
          Text('فوائد التبرع بالدم',style: TextStyle(fontSize: 18)),
          Text('من يمكنه التبرع بالدم ؟',style: TextStyle(fontSize: 18)),
          Text('من يمكنه التبرع بالدم ؟',style: TextStyle(fontSize: 18)),
          Text('من يمكنه التبرع بالدم ؟',style: TextStyle(fontSize: 18)),
          Text('التبرع لأول مرة',style: TextStyle(fontSize: 18)),
          Text('قواعد المنح بين فضائل الدم',style: TextStyle(fontSize: 18)),
        ],
      ),
    );
  }
